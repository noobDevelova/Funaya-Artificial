                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        <td class="px-4 py-3">
                            <div class="flex items-center text-sm">
                                <div>
                                    <p class="font-semibold"><?= esc($supplier->name) ?></p>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-4 text-sm">
                                <button @click="openModal({
                                    ...
                                    additionalData: { slug: '<?= $supplier->slug ?>' },
                                    loadAction: (data) => getSupplier(data.slug) 
                                })"
                                ...
                                <button @click="openModalConfirm({
                                        ...
                                        description: 'Supplier akan dihapus, Produk yang bersangkutan akan terdampak.',
                                        confirmAction: (data) => deleteSupplier(data.slug),
                                        additionalData: { slug: '<?= $supplier->slug ?>' }
                                })"
...
<?= $this->include('supplier/list/ModalFormEditSupplier')  ?>

<?= $this->include('supplier/list/ModalFormEditSupplierHandler')  ?>

<?= $this->include('supplier/list/ModalDeleteSupplier')  ?>

<?= $this->include('supplier/list/ModelDeleteSupplierHandler')  ?>