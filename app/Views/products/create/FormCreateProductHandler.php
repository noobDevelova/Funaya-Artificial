<script type="text/template" id="template-container">
    <div class="dz-preview dz-file-preview dz-image-preview flex flex-col items-center justify-center p-1 border-2 border-gray-300 rounded-lg shadow-md bg-gray-800 w-full">
        <div class="dz-image  mb-4 w-full">
            <img class="object-cover rounded-lg w-full" data-dz-thumbnail />
        </div>
